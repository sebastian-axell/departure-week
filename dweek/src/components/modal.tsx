...
import { BASE_URL, Item, People } from "./constants";
import Spinner from "./constants";
import axios from "axios";

export default function Modal({ handleOnClick: closeModal, currentThing }: { handleOnClick: () => void, currentThing: Item }) {
