                        ...
                        <div className="ml-2">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800">{event.title}</h3>
                            {
                                <div>
                                    ...
                                    <button onClick={() => { setCurrentEvent(event); setIsEventModalOpen(true) }} className="mx-auto w-full p-2 bg-gray-200 rounded-lg mt-2 hover:bg-gray-400">sign me up</button>
                                </div>
                            }
                        </div>
                    </div>
