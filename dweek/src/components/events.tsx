                    ...
                    <div key={index} className="relative mb-10">
                        {
                            index === allEvents.length - 1 ?
                                <div className="absolute left-[-1.75rem] top-1.5 w-3 h-3 rounded-full z-10 border-2 shadow">
                                    <img src="/denmark.svg" className="scale-[140%]"/>
                                </div>
                                :
                                <div className="absolute left-[-1.75rem] top-1.5 w-3 h-3 bg-yellow-300 rounded-full z-10 border-2 shadow" />
                        }
                        <div className="ml-2">
